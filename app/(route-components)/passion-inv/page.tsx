...
export default function PassionInvesting() {
    return (
        <main className="flex flex-col pt-8">
            ...
            {/* Full width banner */}
            <div className="w-screen relative left-1/2 -translate-x-1/2 bg-stone-200/40 py-16 md:py-20">
                <div className="flex items-start gap-12 lg:gap-16 lg:max-w-4xl md:max-w-2xl max-w-sm mx-auto px-6 md:px-0">

                    <div className="flex-1">
                        <motion.p
                            className="text-xs font-medium text-emerald-600 tracking-widest uppercase mb-4"
                        ...
                        <motion.h1
                            className="font-bold text-4xl lg:text-5xl leading-tight mb-5"
                            variants={textVariants}
                            initial="hidden"
                            animate="visible"
                            custom={1}
                        ...
                        <div className="text-base lg:text-lg leading-relaxed space-y-5">
                            <motion.p
                                variants={textVariants}
                                initial="hidden"
                                animate="visible"
